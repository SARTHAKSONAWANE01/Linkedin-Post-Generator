    ...
    <div className="space-y-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="w-8 h-8 rounded-lg bg-blue-500/10 text-[#0A66C2] dark:text-blue-400 flex items-center justify-center">
              <BookOpen className="w-4 h-4" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-black text-slate-900 dark:text-slate-100">{avgReadability}%</span>
          ...
          <div className="h-1.5 w-full bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
            <div className="h-full bg-[#0A66C2] rounded-full" style={{ width: `${avgReadability}%` }} />
          </div>
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-black text-slate-900 dark:text-slate-100">{avgHook}%</span>
            <span className="text-[10px] text-sky-600 dark:text-sky-450 font-semibold flex items-center gap-0.5">
              <TrendingUp className="w-3 h-3" /> Strong
            </span>
          </div>
          {/* Progress bar */}
          <div className="h-1.5 w-full bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
            <div className="h-full bg-sky-500 rounded-full" style={{ width: `${avgHook}%` }} />
          </div>
          <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed">
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-black text-slate-900 dark:text-slate-100">{avgCta}%</span>
          ...
          {/* Progress bar */}
          <div className="h-1.5 w-full bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
            <div className="h-full bg-indigo-500 rounded-full" style={{ width: `${avgCta}%` }} />
          </div>
          <p className="text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="glass-card rounded-2xl p-6 space-y-5">
            <div>
              <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 flex items-center gap-2">
                <Sparkles className="w-5 h-5 text-[#0A66C2] animate-bounce" />
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="p-4 rounded-xl bg-slate-50/60 dark:bg-slate-900/35 border border-slate-205 dark:border-slate-800 space-y-2">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xs font-bold text-slate-900 dark:text-slate-100">{rec.check}</h3>
                    <span className={`text-[9px] font-bold px-2 py-0.5 rounded-full border ${rec.statusColor}`}>
                      {rec.status}
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">{rec.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="glass-card rounded-2xl p-6 space-y-4">
            <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">LinkedIn Optimization Laws</h2>
            <p className="text-slate-550 dark:text-slate-400 text-xs">A checklist of the core structure guidelines automatically enforced by Forge.</p>
            
            <ul className="space-y-3.5 text-xs text-slate-700 dark:text-slate-350">
              <li className="flex items-start gap-2.5">
                <span className="w-5 h-5 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center text-[10px] shrink-0 font-bold">1</span>
                <div>
                  <span className="font-bold block text-slate-900 dark:text-slate-200">The 3-Second Hook Rule</span>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 block mt-0.5">Start with a metric, tension, or counter-intuitive claim. Strip conversational headers.</span>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="w-5 h-5 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center text-[10px] shrink-0 font-bold">2</span>
                <div>
                  <span className="font-bold block text-slate-900 dark:text-slate-200">Sentence Variance Rhythm</span>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 block mt-0.5">Alternate single-sentence lines with short punchy paragraphs to build narrative momentum.</span>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
                <span className="w-5 h-5 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 flex items-center justify-center text-[10px] shrink-0 font-bold">3</span>
                <div>
                  <span className="font-bold block text-slate-900 dark:text-slate-200">Inclusive Accessibility Standard</span>
                  <span className="text-[10px] text-slate-500 dark:text-slate-400 block mt-0.5">Do not use bold unicode fonts which fail to render on screen readers. Use clear caps headlines.</span>
                </div>
              </li>
            </ul>
          </div>
